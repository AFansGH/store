...
<script type="text/javascript">
	$(function(){
		$("#cart").click(function(){
				...
				var pid = ${requestScope.product.pid };
				location.href = "${pageContext.request.contextPath}/productCentre?method=cart&buyNum="+buyNum+"&pid="+pid+"&cid=${requestScope.cid}&currentPage=${requestScope.currentPage}";
		});
	});
	...
	<div class="container">
		<div class="row">
			<div
				...
				<a href="${pageContext.request.contextPath}/productCentre?method=productListById&cid=${requestScope.product.cid }">数码&nbsp;&nbsp;&gt;
				</a>
				<a>
					手机数码
				</a>
			...
			<div style="margin: 0 auto; width: 950px;">
				...
				<div class="col-md-6">
					...
					<div
						...
						<div style="margin: 5px 0 10px 0;">${requestScope.product.pdesc }</div>
						...
						<!-- 点击加入购物车应该准备数据发送到servle中，根据购物车分析，应该加入的数据为pid -->
							<a href="javascript:void(0)" id="cart"> <input
								style="background: url('./images/product.gif') no-repeat scroll 0 -600px rgba(0, 0, 0, 0); height: 36px; width: 127px;"
								value="加入购物车" type="button">
							</a> &nbsp;收藏商品
							<span style="color: red">${addFlag }</span>
							
						</div>
					</div>
					<a href="${pageContext.request.contextPath}/productCentre?method=productListById&cid=${requestScope.cid}&currentPage=${requestScope.currentPage}"><span style="margin-left: 30px">返回上一页</span></a>
