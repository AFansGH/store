	...
	<body>
		<div class="container-fluid">
			...
			<div class="container-fluid">
				...
				<!-- 热门商品div 用el加jstl完成拿数据与遍历的动作-->
					
					<c:forEach items="${requestScope.hotProductList }" var="hotProduct">
						<div class="col-md-2" style="text-align:center;height:200px;padding:10px 0px;">
							<a href="${pageContext.request.contextPath }/productCentre?method=productInfo&pid=${hotProduct.pid }&cid=${hotProduct.cid }&currentPage=1">
								<img src="${pageContext.request.contextPath }/${hotProduct.pimage}" width="130" height="130" style="display: inline-block;">
							</a>
							<p><a href="${pageContext.request.contextPath }/productCentre?method=productInfo&pid=${hotProduct.pid }&cid=${hotProduct.cid }&currentPage=1" style='color:#666'>${hotProduct.pname}</a></p>
			...
			<div class="container-fluid">
				...
				<div class="col-md-10">
					...
					<!-- 最新商品div 用el加jstl完成拿数据与遍历的动作-->
					
					<c:forEach items="${requestScope.newProductList }" var="newProduct">
						<div class="col-md-2" style="text-align:center;height:200px;padding:10px 0px;">
							<a href="${pageContext.request.contextPath }/productCentre?method=productInfo&pid=${newProduct.pid }&cid=${newProduct.cid }&currentPage=1">
								<img src="${pageContext.request.contextPath }/${newProduct.pimage}" width="130" height="130" style="display: inline-block;">
							</a>
							<p><a href="${pageContext.request.contextPath }/productCentre?method=productInfo&pid=${newProduct.pid }&cid=${newProduct.cid }&currentPage=1" style='color:#666'>${newProduct.pname}</a></p>
